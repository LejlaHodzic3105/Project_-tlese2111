...
std::cout << "1.If you want to search by username enter 1:" << std::endl;
std::cout << "2.If you want to search by name and surname enter 2:" << std::endl;
std::string s1,s2;
int c;
cin >> c;
if(c==1){ std::cout << "Enter username: ";
cin.ignore();
getline(std::cin,s1);
try{listU.findUserByUsername(s1).printUser();}
catch(std::string a){std::cout << a << std::endl;}
}
else if(c==2){std::cout << "Enter name and surname:";
std::cin >> s1 >> s2;
try{listU.findUserByName(s1,s2).printUser();}
catch(std::string a){std::cout << a << std::endl;}
}
...
User newuser=User(name,surname,unob,uname,upass);
listU.addUser(newuser);
}

else if(choice==10){
std::cout << "1.Enter 1 if you want to remove the user by entering the username" << std::endl;
std::cout << "2.Enter 2 if you want to remove the user by entering the name and the surname" << std::endl;
std::string s1,s2;
int iz;
cin >> iz;
if(iz==1){
...
cin.ignore();
getline(cin,s1);
listU.findUserByUsername(s1).printBorrowedFilms();
}
else if(iz==2){
cout << "Enter the name and the surname: ";
cin >> s1 >> s2;
listU.findUserByName(s1,s2).printBorrowedFilms();
}
}
...
cin.ignore();
getline(cin,s1);
listU.findUserByUsername(s1).printHistory();
}
else if(iz==2){
cout << "Enter the name and the surname: ";
cin >> s1 >> s2;
listU.findUserByName(s1,s2).printHistory();
}
}
